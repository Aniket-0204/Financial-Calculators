function LumpsumSummary({ invested, returns, total }) {
    return (
        <section className="mt-8 pt-8 border-t border-slate-800" aria-label="Lumpsum Summary">
            <dl>
